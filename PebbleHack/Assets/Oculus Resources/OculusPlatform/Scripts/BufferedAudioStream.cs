...
public class BufferedAudioStream {
  ...
  public void AddData(float[] samples, int samplesLength) {
    int remainingWriteLength = samplesLength;
...
#endif
    remainingBufferTime += (float)samplesLength / sampleRate;
#if VERBOSE_LOGGING
    Debug.Log(string.Format("previous remaining: {0}, new remaining: {1}, added {2} samples", prev, remainingBufferTime, samplesLength));
#endif
